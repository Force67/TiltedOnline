...
#include <Messages/ServerWeatherSettings.h>

void ServerWeatherSettings::SerializeRaw(TiltedPhoques::Buffer::Writer& aWriter) const noexcept
{
...
void ServerWeatherSettings::DeserializeRaw(TiltedPhoques::Buffer::Reader& aReader) noexcept
{
    /*
    uint64_t tmp = 0;
    uint32_t cVal = 0;
