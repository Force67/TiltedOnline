...
static constexpr Title kTitleMap[] = {
    {0,      L"Unknown",                "Unknown",      L"Unknown"}, 
...
static_assert(sizeof(kTitleMap) / sizeof(Title) == 
    static_cast<size_t>(Title::Id::kCount), "Title map <=> Enum mismatch");
